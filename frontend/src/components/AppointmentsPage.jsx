...
const AppointmentsPage = () => {
    ...
    const fetchAppointments = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/personal`, {   headers: {
          Authorization: token,
        },});
    ...
    const createAppointment = async () => {
      try {
        ...
        fetchAppointments();
        setFormData({ job_centre_id: "", date: "", address: "", benefit_name: "" });
      } catch (error) {
    ...
    const updateAppointment = async () => {
      try {
        await axios.put(`${API_BASE_URL}/update/${editId}`, formData, {   headers: {
          Authorization: token,
        },});
    ...
    const deleteAppointment = async (id) => {
      try {
        await axios.delete(`${API_BASE_URL}/delete/${id}`, {   headers: {
          Authorization: token,
        },});
      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            required
          />
          <button type="submit">{editId ? "Update Appointment" : "Create Appointment"}</button>
              ...
              {appointments.map((appointment) => (
                <tr key={appointment.appointment_id}>
                  ...
                  <td>
                    ...
                    <button onClick={() => deleteAppointment(appointment.appointment_id)}>
                      Delete
                    </button>
                  </td>
                </tr>
